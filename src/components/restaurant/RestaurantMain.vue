      ...
      <div class="container">
		...
		<section class="ftco-section ftc-no-pb ftc-no-pt">
			<div class="container">
				<div>
				<div class="row"  >
					<div id="res1" class="col-md-5 p-md-5 img img-2 img-3 d-flex justify-content-center align-items-center" style="background-image ">
					</div>
...
export default {
	...
	methods :{
		async getRes(){
		await axios.get('http://localhost:8000/api/off').then(res=>{
