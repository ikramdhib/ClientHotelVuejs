      ...
      <div class="container">
        ...
        <div class="row block-9 slide-top py-4">
          ...
          <div class="col-md-5 heading-section text-center">
                <input type="submit" value="Vérifier les disponibilités" v-on:click="addUser()" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20 py-3 px-5">
              </div>
                  </div>
              </div>
            </form>
