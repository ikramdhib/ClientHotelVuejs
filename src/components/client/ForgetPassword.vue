            ...
            <form class="bg-white p-5 contact-form">
              <div class="form-group">
               ...
               <div class="form-group">
                  <div class="row">
                  <div class="col-md-6"> 
                 <input type="submit" value="Chercher" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20 py-3 px-5" v-on:click="forgetpass()">
                      </div>
                <div class="col-md-6"> 
                <router-link to="/">   <input type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20 py-3 px-5" value="Annuler" style="background-color: #D3D3D3;"></router-link>
                    </div>
              </div>
              </div>
            </form>
    ...
    methods:{
        ...
        async forgetpass(){
          await axios.post('http://localhost:8000/api/user/forget-password',{
             ...
             localStorage.setItem('email_client', this.email)
