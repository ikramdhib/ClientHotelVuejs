      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <h1 class="mb-4 bread"> Salle de conference   </h1>
            </div>
          </div>
        </div>
    </div>
		...
		<section class="ftco-section ftc-no-pb ftc-no-pt">
			<div class="container">
				<div>
				<div class="row"  >
					<div id="salle" class="col-md-5 p-md-5 img img-2 img-3 d-flex justify-content-center align-items-center" style="background-image ">
            ...
            <div class="bg-white p-5">
                  ...
                  <div class="col-md-4"  v-for="ret in salles" :key="ret.id"> 
                    ...
                    <div class="card-body">
					  ...
					  <hr/>
                      <p class="card-text"> {{ret.description.substr(0 , 110)+',...'}}  <input type="button" value="plus details" class="btn btn-primary" @click="goDetails(ret.id)" id="bt" > </p>
					  <hr/>
