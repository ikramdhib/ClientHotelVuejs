...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none">
  <symbol id="star" viewBox="0 0 26 28">
    ...
    <textarea class="form-control" placeholder="Ajouter commentaire" id="exampleFormControlTextarea1" v-model="rating.commentaire" rows="6" cols="8"></textarea>
            ...
            <div class="bg-white p-5">
                  ...
                  <div class="col-md-4"  v-for="ret in poolcard" :key="ret.id"> 
                    ...
                    <div class="card-body">
					  ...
					  <hr/>
                      <p class="card-text"> {{ ret.description }}  <input type="button" id="bt" value="plus details" class="btn btn-primary" @click="goDetails(ret.id)"  >   </p>
	...
	methods :{
		...
		await axios.get('http://localhost:8000/api/alloffimg/'+id).then(res=>{
				if(res!=null){
					...
					this.pool_id=res.data.rooftop.id
